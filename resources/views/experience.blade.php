            ...
            <div class="-my-8 divide-y-2 divide-gray-100">
                    <div class="py-8 flex flex-wrap md:flex-nowrap">
                        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                            <span class="font-semibold title-font ">{{ $experience->company->name }}</span>
                            ...
                            <img class="w-20 h-20 mt-5 bg-gray-100 rounded-md" src="images/company/{{ $experience->company->logo }}" alt="" >
                        </div>
                            ...
                            <ul class="list-none mt-6">
                                @foreach ($experience->skills as $skill)
                                    <li class="flex items-center">
                                        <span class="inline-flex text-xs font-semibold text-gray-200 0">
                                            {{ $skill->name }}
                                        </span>
                                    </li>
                                @endforeach
